...
namespace HHBK_Chemicals_ERP_CS.Lieferung
{
    ...
    public class Lieferposition
    {
        ...
        public Lieferposition(int id, string liefernummer, DateTimeOffset versanddatum, DateTimeOffset lieferdatum, string nameVersandkontrolle, string nameSpedition)
        {
            Id = id;
